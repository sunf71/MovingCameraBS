...
{
	// Open the video file
    cv::VideoCapture capture("../wildlife.wmv");
	...
	// Open video file
	processor.setInput("../wildlife.wmv");
...
//	processor.setOutput("../output/bikeOut",".jpg");
	char codec[4];
	processor.setOutput("../output/wildlife.wmv",processor.getCodec(codec),processor.getFrameRate());
